...
/**
 * ZoomSDKInviteHelper is class which used to get/set some settings in meeting.
 */
@interface ZoomSDKInviteHelper : NSObject
...
/**
 * To enable customize meeting invitation for Partner
 *
 * *Note*: If set customizeInvite to YES, partner can customize the view controller of Invitation.
 */
@property (assign, nonatomic) BOOL customizeInvite;

/**
 * To set the name of invite participant view controller
 */
@property (retain, nonatomic) NSString *inviteVCName;
...
/**
 * Returns the instance of ZoomSDKInviteHelper
 */
+ (ZoomSDKInviteHelper*)sharedInstance;
