$(function () {
    ...
    window.UpdateUserList = function () {
        ...
        for(i = 0; i < count; i++) {
            ...
            if(currentLoginType === 'facebook' || currentLoginType === 'google') {


                if(!online || displayUserCount > MAX_USER_COUNT) {
                ...
                if(currentLoginType === 'facebook') {
                    ...
                    // online - 0, dnd - 1, idle - 2, offline - 3
                    onlineimagename = 'Status_Available';
                    if(customPresence === 0) {
                        onlineimagename = 'Status_Available';
                    } else if(customPresence === 1) {
                        onlineimagename = 'Status_DND';
                    } else if(customPresence === 2) {
                        onlineimagename = 'Status_Idle';
                    } else if(customPresence === 3) {
                        onlineimagename = 'Status_offline';
                    }

                }

            } else if(currentLoginType === 'zoomus' || currentLoginType === 'sso') {
